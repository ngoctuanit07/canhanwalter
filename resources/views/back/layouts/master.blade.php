            ...
            <div class="main-header-right row">
                ...
                <div class="mobile-sidebar">
                    <div class="media-body text-right switch-sm">
                        <label class="switch"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="nav-right col">
                        ...
                        <li class="onhover-dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <ul class="notification-dropdown onhover-show-div p-0">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-body">
                                            <h6 class="mt-0"><span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-body">
                                            <h6 class="mt-0 txt-success"><span><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li>
                                    <div class="media">
                                        <div class="media-body">
                                            <h6 class="mt-0 txt-danger"><span><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round"
                    ...
                    <div class="d-lg-none mobile-toggle pull-right"><svg xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        <li class="active"><a class="sidebar-header active" href="index.html"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <li><a class="sidebar-header" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <li><a class="sidebar-header" href="media.html"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li><a class="sidebar-header" href="reports.html"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li><a class="sidebar-header" href="invoice.html"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li><a class="sidebar-header" href="login.html"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div>
                    <div class="container p-0">
                        <div class="modal-header p-l-20 p-r-20">
                            ...
                            <div class="col-sm-4 text-right p-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 xl-100">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="market-chart"><svg xmlns:ct="http://gionkunz.github.com/chartist-js/ct"
                                            width="100%" height="100%" class="ct-chart-bar"
                                            style="width: 100%; height: 100%;">
                                            <g class="ct-grids">
                                                <line y1="273" y2="273" x1="40" x2="559" class="ct-grid ct-vertical">
                                                </line>
                                                <line y1="244.33333333333334" y2="244.33333333333334" x1="40" x2="559"
                                                    class="ct-grid ct-vertical"></line>
                                                <line y1="215.66666666666666" y2="215.66666666666666" x1="40" x2="559"
                                                    class="ct-grid ct-vertical"></line>
                                                <line y1="187" y2="187" x1="40" x2="559" class="ct-grid ct-vertical">
                                                </line>
                                                <line y1="158.33333333333331" y2="158.33333333333331" x1="40" x2="559"
                                                    class="ct-grid ct-vertical"></line>
                                                <line y1="129.66666666666666" y2="129.66666666666666" x1="40" x2="559"
                                                    class="ct-grid ct-vertical"></line>
                                                <line y1="101" y2="101" x1="40" x2="559" class="ct-grid ct-vertical">
                                                </line>
                                                <line y1="72.33333333333334" y2="72.33333333333334" x1="40" x2="559"
                                                    class="ct-grid ct-vertical"></line>
                                                <line y1="43.66666666666666" y2="43.66666666666666" x1="40" x2="559"
                                                    class="ct-grid ct-vertical"></line>
                                            ...
                                            <g>
                                                <g class="ct-series ct-series-a">
                                                    <line x1="66.4375" x2="66.4375" y1="273" y2="129.66666666666666"
                                                        class="ct-bar" ct:value="2.5"></line>
                                                    <line x1="131.3125" x2="131.3125" y1="273" y2="101" class="ct-bar"
                                                        ct:value="3"></line>
                                                    <line x1="196.1875" x2="196.1875" y1="273" y2="101" class="ct-bar"
                                                        ct:value="3"></line>
                                                    <line x1="261.0625" x2="261.0625" y1="273" y2="221.4" class="ct-bar"
                                                        ct:value="0.9"></line>
                                                    <line x1="325.9375" x2="325.9375" y1="273" y2="198.46666666666664"
                                                        class="ct-bar" ct:value="1.3"></line>
                                                    <line x1="390.8125" x2="390.8125" y1="273" y2="169.8" class="ct-bar"
                                                        ct:value="1.8"></line>
                                                    <line x1="455.6875" x2="455.6875" y1="273" y2="55.133333333333326"
                                                        class="ct-bar" ct:value="3.8"></line>
                                                    <line x1="520.5625" x2="520.5625" y1="273" y2="187" class="ct-bar"
                                                        ct:value="1.5"></line>
                                                </g>
                                                <g class="ct-series ct-series-b">
                                                    <line x1="78.4375" x2="78.4375" y1="273" y2="55.133333333333326"
                                                        class="ct-bar" ct:value="3.8"></line>
                                                    <line x1="143.3125" x2="143.3125" y1="273" y2="169.8" class="ct-bar"
                                                        ct:value="1.8"></line>
                                                    <line x1="208.1875" x2="208.1875" y1="273" y2="26.466666666666697"
                                                        class="ct-bar" ct:value="4.3"></line>
                                                    <line x1="273.0625" x2="273.0625" y1="273" y2="141.13333333333333"
                                                        class="ct-bar" ct:value="2.3"></line>
                                                    <line x1="337.9375" x2="337.9375" y1="273" y2="66.6" class="ct-bar"
                                                        ct:value="3.6"></line>
                                                    <line x1="402.8125" x2="402.8125" y1="273" y2="112.46666666666667"
                                                        class="ct-bar" ct:value="2.8"></line>
                                                    <line x1="467.6875" x2="467.6875" y1="273" y2="112.46666666666667"
                                                        class="ct-bar" ct:value="2.8"></line>
                                                    <line x1="532.5625" x2="532.5625" y1="273" y2="112.46666666666667"
                                                        class="ct-bar" ct:value="2.8"></line>
                                                </g>
                                            </g>
                                            <g class="ct-labels">
                                                <foreignObject style="overflow: visible;" x="40" y="278" width="64.875"
                                                    height="20"><span class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">100</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="104.875" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">200</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="169.75" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">300</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="234.625" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">400</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="299.5" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">500</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="364.375" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">600</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="429.25" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">700</span></foreignObject>
                                                <foreignObject style="overflow: visible;" x="494.125" y="278"
                                                    width="64.875" height="20"><span
                                                        class="ct-label ct-horizontal ct-end"
                                                        xmlns="http://www.w3.org/2000/xmlns/"
                                                        style="width: 65px; height: 20px;">800</span></foreignObject>
                                                ...
                                                <foreignObject style="overflow: visible;" y="-15" x="0" height="30"
                                        ...
                                        <div class="col-6">
                                            <div class="small-chartjs">
                                                <div class="flot-chart-placeholder" id="simple-line-chart-sparkline-3">
                                                    <canvas width="102" height="60"
                                                        style="display: inline-block; width: 102.25px; height: 60px; vertical-align: top;"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body sell-graph">
                                    <canvas id="myGraph" width="1268" height="314"
                                        style="width: 1268px; height: 314px;"></canvas>
                                    <div class="code-box-copy">
                                        <button class="code-box-copy__btn btn-clipboard"
                                            data-clipboard-target="#example-head3" title=""
                                            data-original-title="Copy"><i class="icofont icofont-copy-alt"></i></button>
                                        <pre
                                            class="  language-html"><code class="  language-html" id="example-head3"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation">=</span><span class="token punctuation">"</span>card-body sell-graph<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
                                                ...
                                                <tr>
                                                    <td class="bd-t-none u-s-tb">
                                                        <div class="align-middle image-sm-size"><img
                                                                ...
                                                                data-original-title="" title="">
                                                            <div class="d-inline-block">
                                                                <h6>Holio Mako <span class="text-muted digits">(250+
                                                                        Online)</span></h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                        ...
                                        <div class="col-xl-3 col-sm-6 xl-50">
                                            <div class="order-graph">
                                                ...
                                                <div class="chart-block chart-vertical-center">
                                                    <canvas id="myDoughnutGraph" width="280" height="140"
                                                        style="width: 280px; height: 140px;"></canvas>
                                                </div>
                                            ...
                                            <div class="order-graph sm-order-space">
                                                ...
                                                <div class="order-graph-bottom sales-location">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="mb-0 mr-0">Germany <span
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="mb-0 mr-0">Brasil <span
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="mb-0 mr-0">United Kingdom<span
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="mb-0 mr-0">Australia<span
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="mb-0 mr-0">Canada <span
                                                                    class="pull-right">25%</span></h6>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-6 xl-100">
                                            <div class="order-graph xl-space">
                                                ...
                                                <div class="ct-4 flot-chart-container"><svg
                                                        ...
                                                        style="width: 100%; height: 100%;">
                                                        <g class="ct-grids">
                                                            <line x1="50" x2="50" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="115.5" x2="115.5" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="181" x2="181" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="246.5" x2="246.5" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="312" x2="312" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="377.5" x2="377.5" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="443" x2="443" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line x1="508.5" x2="508.5" y1="15" y2="365"
                                                                class="ct-grid ct-horizontal"></line>
                                                            <line y1="365" y2="365" x1="50" x2="574"
                                                                class="ct-grid ct-vertical"></line>
                                                            <line y1="326.1111111111111" y2="326.1111111111111" x1="50"
                                                                x2="574" class="ct-grid ct-vertical"></line>
                                                            <line y1="287.22222222222223" y2="287.22222222222223"
                                                                x1="50" x2="574" class="ct-grid ct-vertical"></line>
                                                            ...
                                                            <line y1="131.66666666666666" y2="131.66666666666666"
                                                                x1="50" x2="574" class="ct-grid ct-vertical"></line>
                                                            <line y1="92.77777777777777" y2="92.77777777777777" x1="50"
                                                                x2="574" class="ct-grid ct-vertical"></line>
                                                        ...
                                                        <g>
                                                            <g class="ct-series ct-series-a">
                                                                <path
                                                                    d="M50,365L50,170.556C71.833,118.704,93.667,15,115.5,15C137.333,15,159.167,92.778,181,92.778C202.833,92.778,224.667,53.889,246.5,53.889C268.333,53.889,290.167,139.444,312,170.556C333.833,201.667,355.667,248.333,377.5,248.333C399.333,248.333,421.167,170.556,443,170.556C464.833,170.556,486.667,196.481,508.5,209.444L508.5,365Z"
                                                                    class="ct-area"></path>
                                                                <path
                                                                    d="M50,170.556C71.833,118.704,93.667,15,115.5,15C137.333,15,159.167,92.778,181,92.778C202.833,92.778,224.667,53.889,246.5,53.889C268.333,53.889,290.167,139.444,312,170.556C333.833,201.667,355.667,248.333,377.5,248.333C399.333,248.333,421.167,170.556,443,170.556C464.833,170.556,486.667,196.481,508.5,209.444"
                                                                    class="ct-line"></path>
                                                                <line x1="50" y1="170.55555555555554" x2="50.01"
                                                                    y2="170.55555555555554" class="ct-point"
                                                                    ct:value="5"></line>
                                                                <line x1="115.5" y1="15" x2="115.51" y2="15"
                                                                    class="ct-point" ct:value="9"></line>
                                                                <line x1="181" y1="92.77777777777777" x2="181.01"
                                                                    y2="92.77777777777777" class="ct-point"
                                                                    ct:value="7"></line>
                                                                <line x1="246.5" y1="53.888888888888914" x2="246.51"
                                                                    y2="53.888888888888914" class="ct-point"
                                                                    ct:value="8"></line>
                                                                <line x1="312" y1="170.55555555555554" x2="312.01"
                                                                    y2="170.55555555555554" class="ct-point"
                                                                    ct:value="5"></line>
                                                                <line x1="377.5" y1="248.33333333333331" x2="377.51"
                                                                    y2="248.33333333333331" class="ct-point"
                                                                    ct:value="3"></line>
                                                                <line x1="443" y1="170.55555555555554" x2="443.01"
                                                                    y2="170.55555555555554" class="ct-point"
                                                                    ct:value="5"></line>
                                                                <line x1="508.5" y1="209.44444444444446" x2="508.51"
                                                                    y2="209.44444444444446" class="ct-point"
                                                                    ct:value="4"></line>
                                                            </g>
                                                        </g>
                                                        <g class="ct-labels">
                                                            <foreignObject style="overflow: visible;" x="50" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">1</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="115.5" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">2</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="181" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">3</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="246.5" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">4</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="312" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">5</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="377.5" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">6</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="443" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">7</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;" x="508.5" y="370"
                                                                width="65.5" height="20"><span
                                                                    class="ct-label ct-horizontal ct-end"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="width: 66px; height: 20px;">8</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;"
                                                                y="326.1111111111111" x="10" height="38.888888888888886"
                                                                width="30"><span class="ct-label ct-vertical ct-start"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="height: 39px; width: 30px;">0</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;"
                                                                y="287.2222222222222" x="10" height="38.888888888888886"
                                                                width="30"><span class="ct-label ct-vertical ct-start"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="height: 39px; width: 30px;">1</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;"
                                                                y="248.33333333333331" x="10" height="38.8888888888889"
                                                                width="30"><span class="ct-label ct-vertical ct-start"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                                    style="height: 39px; width: 30px;">2</span>
                                                            </foreignObject>
                                                            <foreignObject style="overflow: visible;"
                                                                y="209.44444444444446" x="10" height="38.88888888888887"
                                                                width="30"><span class="ct-label ct-vertical ct-start"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
                                                            ...
                                                            <foreignObject style="overflow: visible;"
                                                                y="92.77777777777777" x="10" height="38.888888888888886"
                                                                width="30"><span class="ct-label ct-vertical ct-start"
                                                                    xmlns="http://www.w3.org/2000/xmlns/"
